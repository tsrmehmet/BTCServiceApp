...
var FileUpload = function() {
    ...
    var _componentFileUpload = function() {
        ...
        // EXAMPLE START
        $('.file-thumbnail').fileinput({
            fileActionSettings: fileActionThumbSettings,
            ...
            layoutTemplates: { 
                //main2: "<div class=\"d-inline-block\">{preview}</div> <div><span class=\"mr-2\">{upload}</span> {remove} {browse}</div>",
                footer: '',
            },
        });
